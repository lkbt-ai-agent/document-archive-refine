...
- `03-domains/` — 비즈니스 기능·프로세스·도메인 규칙(자연어)
  - [folders](./03-domains/folders.md) — 폴더 트리 CRUD·MOVE
  - [document](./03-domains/document.md) — 문서 업/다운/삭제·레코드 상태
  - [ingestion](./03-domains/ingestion.md) — 추출·OCR·메타·청킹·임베딩
  - [search-and-rag](./03-domains/search-and-rag.md) — 하이브리드 검색·RAG
  - [ai-outputs](./03-domains/ai-outputs.md) — 요약/초안/보고서·계보
- `04-data/` — 전체 스키마(폴더·문서·청크·계보), 인덱스, Alembic
  - [schema-rule](./04-data/schema-rule.md) — 횡단 규칙(설계·명명·확장·Alembic·TODO)
  - [erd](./04-data/erd.md) — 엔티티 관계
  - [users-schema](./04-data/users-schema.md) — 사용자 스키마
  - [folders-schema](./04-data/folders-schema.md) — 폴더 스키마
  - [documents-schema](./04-data/documents-schema.md) — 문서·청크 스키마
  - [documents-minio](./04-data/documents-minio.md) — 문서 MinIO 오브젝트 로직·운영
  - [generations-schema](./04-data/generations-schema.md) — 생성 계보 스키마
  - [search-schema](./04-data/search-schema.md) — 검색 실 쿼리(키워드·의미·하이브리드)
