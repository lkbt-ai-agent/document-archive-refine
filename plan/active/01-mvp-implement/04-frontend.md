...
## 검색·산출물·반응형·테마
- [ ] C1 통합 검색 — SearchBar + "검색..." 모드 드롭다운(키워드/의미/rag), 결과는 Center(리스트/답변)·제목 옆 뒤로가기·소요/개수/청크 toggle (§6, search-frontend).
...
- [ ] C5 MinIO 버킷 CORS 설정(브라우저 presigned 호출용) (§9, document-backend §7).
