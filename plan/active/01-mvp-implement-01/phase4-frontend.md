...
created: 2026-06-11
completed: —
overview: Phase 1 프로토타입 승계 → 목업 제거·실 API 배선(Left 트리 / Center 목록 / Right 토글 인스펙터, frontend-drive-ui).
---
...
## 검색·반응형·테마
- [ ] C1 검색·RAG 질문(AskDialog) — 인용 딥링크 + 생성 UI + 소요 시간 표시 (search-and-rag §11).
