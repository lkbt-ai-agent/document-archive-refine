...
> 사고 진단과 수치 근거는 `docs/lessons/01-bulk-upload-llm-overload.md`(§0 구성 한도·Fix 권장안 A)다.
...
## 문서 반영
- [x] E1 `docs/lessons/01-bulk-upload-llm-overload.md`의 `status`를 resolved로 바꾸고 Fix에 적용/미채택 표기를 달았다.
