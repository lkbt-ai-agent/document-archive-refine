# Document Archive AI
- TODO: 각 설계서의 내용은 "AI 를 처음 배우는 개발자" 를 위해 서술되야 하므로, 각 용어에 대한 정의와 설명이 필요하다.
...
## Models
- TODO: MVP 기준에서는 로컬 배포 시 Mac mini A3238 + M4 + 24GB Unified Memory 환경을 고려해야 한다.
- TODO: 추후 일부 모델을 AWS 배드락에 배포할 수도 있다.
### OCR
- TODO: OCR 모델 결정 필요
### Embedding
