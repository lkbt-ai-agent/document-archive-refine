...
docs/requirement.md의 모든 TODO를 외부 설계, 구현 사례 조사로 해소한 2주 MVP 세부 설계 보고서다. 이 문서는 전체 요약이며 세부는 같은 폴더의 01~05 문서로 이어진다.
...
docs/requirement.md의 `Models` 섹션 3개 TODO(OCR / Embedding / Generation)에 대한 결론입니다.
