...
> 📘 **이 설계서는 "AI를 처음 배우는 개발자"도 읽을 수 있도록 작성되었습니다.** 모르는 용어가 나오면 먼저 **[06-glossary.md (용어집)](./06-glossary.md)**를 펼쳐 보세요. 각 문서 상단에는 "💡 이 문서를 읽기 전에" 핵심 용어 박스가 있고, 본문에서 용어가 처음 나올 때 짧은 설명과 용어집 링크를 답니다.
...
| [06-glossary.md](./06-glossary.md) | **AI 입문자용 용어집** — LLM·임베딩·RAG·양자화·통합 메모리·Provider 등 | "AI 처음 배우는 개발자용 서술" |
